...
class Game:
    ...
    def _setup_readline(self) -> None:
        try:
            ...
            import os as _os
            histfile = _os.path.join(_os.path.dirname(_os.path.dirname(_os.path.abspath(__file__))), "data", "history")
    ...
    def _narrative_phase(self) -> None:
        import os
        intro_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "intro.txt")
